...
comorb365 <- map_charlson_codes(obs_raw, comorb_names, map_type = 'charlson', -365, -1) 
# maps codes that occurred at least 15 days to a year prior to admission
comorb365_15 <- map_charlson_codes(obs_raw, comorb_names, map_type = 'charlson', -365, -15) 
# maps codes that occurred at least 14 days to 1 day prior to admission
comorb14_1 <- map_charlson_codes(obs_raw, comorb_names, map_type = 'charlson', -14, -1) 
# map only day of admission
comorb_dayOf <- map_charlson_codes(obs_raw, comorb_names, map_type = 'charlson', 0, 0) 
# consider codes only codes after admission
comorb_After <- map_charlson_codes(obs_raw, comorb_names, map_type = 'charlson', 1, 1000) 
