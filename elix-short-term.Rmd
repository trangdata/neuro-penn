...
list_results = list(
  ...
  severity_demo_table = severity_obfus_table,
  survival_demo_table = survival_obfus_table,
...
penn_results <- lapply(list_results, function(x) mutate(x, site = mysite))
